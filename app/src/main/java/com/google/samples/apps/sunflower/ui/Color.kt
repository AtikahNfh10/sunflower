...
val md_theme_light_primary = Color(0xFFD2B48C)
val md_theme_light_onPrimary = Color(0xFFFDF5E6)
val md_theme_light_primaryContainer = Color(0XFFFF000)
val md_theme_light_onPrimaryContainer = Color(0xFF062100)
val md_theme_light_secondary = Color(0xFF4A3728)
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFD8E7CB)
val md_theme_light_onSecondaryContainer = Color(0xFFDEB887)
...
val md_theme_light_background = Color(0xFFFAF0DD)
val md_theme_light_onBackground = Color(0xFFFAF0DD)
